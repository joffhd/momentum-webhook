...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    // 1) Retrieve full session with line_items and customer_details
    ...
    // 4) Find Memberstack member by email
